...
```{r task i, fig.cap = "**Figure 1.** Annual juvenile hare trap count in Bonanza Creek Experimental Forest between 1998-2012. This total reflects the number of juvenile hares trapped each year during this study."}
...
```{r task ii, fig.align="center", echo = FALSE, fig.width = 7, fig.cap = "**Figure 2.** Juvenile hare weight distribution by site and sex. The group marked NA"}
#subset for data visualization 
