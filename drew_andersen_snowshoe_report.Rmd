...
```{r task ii, fig.align="center", echo = FALSE, fig.width = 7, fig.cap = "**Figure 2.** Juvenile hare body mass distributions by site and sex. The black square on each series indicates the mean of that particular series."}
#subset for data visualization 
...
## C. Juvenile Hare Body Mass Comparison
